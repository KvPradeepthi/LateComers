  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <img
            className="rounded-circle header-profile-user h-60 w-100"
            src="dummyUser.jpg"
            alt="Header Avatar"
          />
        </DropdownToggle>
        <DropdownMenu className="dropdown-menu-end">
          ...
          <Link to="/logout" className="dropdown-item" style={{ color: "#f46a6a" }}>
            <i className="mdi mdi-power font-size-17 align-middle me-1" style={{ color: "#f46a6a" }}/>
